...
CUDA_VISIBLE_DEVICES=4 python code_nlm.py --completion True --data_path data/java-corpus/bigcode --train_dir data/java-corpus/bigcode/model_10000 --test_filename test_10000 --identifier_map data/java-corpus/bigcode/id_test_10000 --gru True --batch_size 10 | tee java_logs/mrr_bpe_10000
